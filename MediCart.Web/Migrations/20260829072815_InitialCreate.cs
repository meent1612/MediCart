        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Medicine_SensitivityLevel", "\"SensitivityLevel\" IN ('high','mid','low') OR \"SensitivityLevel\" IS NULL");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Medicines_ProductTypes_ProductTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SideEffect_Severity", "\"Severity\" IN ('mild','moderate','severe')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Prescription_Status", "\"Status\" IN ('pending','verified','rejected')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_UserId_MedicineId",
                table: "CartItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cities_DivisionId_Name",
                table: "Cities",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medicines_ProductTypeId",
                table: "Medicines",
